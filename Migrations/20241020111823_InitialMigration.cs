        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Balance = table.Column<double>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdviceDescription = table.Column<string>(type: "TEXT", nullable: false),
                    AdviceDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    AdviserId = table.Column<string>(type: "TEXT", nullable: false),
                    AdviseeId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Advice", x => x.AdviceID);
                    table.ForeignKey(
                        name: "FK_Advice_ApplicationUsers_AdviseeId",
                        column: x => x.AdviseeId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Advice_ApplicationUsers_AdviserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountNumbers = table.Column<string>(type: "TEXT", nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Beneficiaries_ApplicationUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<double>(type: "double(18, 2)", nullable: false),
                    Type = table.Column<int>(type: "INTEGER", nullable: false),
                    Balance = table.Column<double>(type: "double(18, 2)", nullable: false),
                    AccountNumber = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Account_AccountNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advice_AdviseeId",
                table: "Advice",
                column: "AdviseeId");

            migrationBuilder.CreateIndex(
                name: "IX_Advice_AdviserId",
                table: "Advice",
                column: "AdviserId");
